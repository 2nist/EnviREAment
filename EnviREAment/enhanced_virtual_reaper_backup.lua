...
local mock_reaper = {
  ...
  ImGui_TabItemFlags_NoReorder = function() return 32 end,  ImGui_TabItemFlags_Leading = function() return 64 end,
  ImGui_TabItemFlags_Trailing = function() return 128 end,

  -- ==================== AUTO-GENERATED IMGUI FUNCTIONS ====================
  -- Generated by imgui_api_generator.py - 272 additional functions
